...
def BMR ():
    ...
    protein = ['Yogurt(1 cup)','Cooked meat(100 g)','Cooked fish(110 g)','1 whole egg + 4 egg whites','Tofu(150 g)']
    fruit = ['Berries(200 g)','Apple','Orange','Banana','Dried Fruits(Handfull)','Fruit Juice(125ml)']
    ...
    ps = ['Soy nuts(50 g)','Low fat milk(250ml)','Hummus(4 Tbsp)','Cottage cheese (125g)','Flavored yogurt(125g)']
    ...
    if gender == 'Male':     
        cal = float()
        cal = 66.0 + (13.7*float(w)) + (5.0*float(h)) - (6.8*float(age))
        print (cal)
    elif gender == 'Female':
        cal = float()
        cal = 655.0 + (9.6*float(w)) + (1.8*float(h)) - (4.7*float(age))
...
l6 = Label(a, text = 'food preference')
l7 = Label(a, text = '')
